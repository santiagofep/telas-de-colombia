...
const EXTRA_KEYWORDS = {
  ...
  Burda: 'forro empaque economica base',
  'Burda perchada': 'abrigo invierno frio peluche',
  Dril: 'uniforme dotacion trabajo pesado industrial pantalon overol vulcano galeon orion camila jean',
  'Dril licrado': 'elastano licra comodo movimiento uniforme',
  ...
  Género: 'camiseta casual punto deportivo',
  Hogar: 'sabana cortina mantel decoracion cojin funda',
  Índigo: 'jean denim mezclilla moda urbana',
  Línea: 'camisa verano fresco liviana',
